  ...
  return (
    <header className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
      ...
      <div className="hidden md:flex items-center justify-center gap-3 text-xs text-slate-400 pb-2 border-b border-white/5 mb-2">
        ...
        <a href="#partners" className="text-blue-400 hover:text-blue-300 inline-flex items-center gap-1 font-medium transition-colors">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between">
          <a href="#" className="flex items-center gap-2.5 group">
            ...
            <div>
              <div className="flex items-center gap-2">
                <span className="text-xl font-bold tracking-tight text-white font-sans">ORDERSPHERE</span>
          ...
          <nav className="hidden lg:flex items-center gap-10 text-sm font-medium text-slate-400">
            {navLinks.map((link) => (
              <a key={link.name} href={link.href} className="hover:text-white transition-colors relative py-1">
                {link.name}
              </a>
            ))}
          </nav>
